...
testCases.forEach((tc, idx) => {
  ...
  const userMatch = tc.expected.username ? parsed.username === tc.expected.username : !parsed.username;
  const passMatch = tc.expected.password ? parsed.password === tc.expected.password : !parsed.password;
