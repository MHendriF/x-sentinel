...
console.log('   P1 (URL with auth):', p1.server === 'http://192.168.1.100:8080' && p1.username === 'admin' ? 'PASSED ✅' : 'FAILED ❌');

const p2 = proxyHelper.parseProxy('10.0.0.5:3128:proxyuser:proxypass');
console.log('   P2 (host:port:user:pass):', p2.server === 'http://10.0.0.5:3128' && p2.username === 'proxyuser' ? 'PASSED ✅' : 'FAILED ❌');
...
const testAcc1 = db.saveAccount({
  ...
  comments: [
    "{Mantap|Keren} bang dari Akun Alpha! 🚀",
    "Insight luar biasa dari Akun Alpha 👍"
  ]
});
