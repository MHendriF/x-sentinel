...
- **Rule**: Automated replies generated by AI must strip surrounding double quotation marks (`"..."`) and adhere to native conversational brevity. Any response that resembles generic AI slop (*"In today's fast-paced world...", "Here are 5 key takeaways..."*) must be filtered by guardrails.
