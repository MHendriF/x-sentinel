...
import { Heart, Repeat, MessageSquare, Sparkles, CheckCircle, Activity, BarChart3 } from 'lucide-react';
...
export const CumulativeBadges: React.FC<CumulativeBadgesProps> = ({
  ...
  return (
    <DeckHeader
      ...
      description="Accumulation of all successful engagements executed across the X-SENTINEL fleet."
      actions={
